...
export const writePost = createAction(WRITE_POST, ({method, name, price, body, tags}) => ({
  method, name, price, body, tags
}));
export const setOriginalPost = createAction(SET_ORIGINAL_POST, post => post);
export const updatePost = createAction(UPDATE_POST, ({id, method, name, price, body, tags}) => ({
  id, method, name, price, body, tags
}),);
